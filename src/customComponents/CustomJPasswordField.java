...
public class CustomJPasswordField extends JPasswordField {
    ...
    public CustomJPasswordField() {
        ...
        setBorder(new EmptyBorder(20, 3, 2, 30));
        ...
        eye = new ImageIcon(getClass().getResource("/customComponents/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/customComponents/eye_hide.png")).getImage();
